...
"a" => Dict( "display" => "inline", "margin" => [0,0,4,4],
             "hover"   => Dict( "text" => Dict("color" => "blue" )),
			 "font"    => Dict( "size" => 13, "family" => "Sans", "weight" => "bold",
...
"code" => Dict( "font" =>  Dict( "size" => 13, "family" => "Courier New", "color" => "black" )),
...
"hr" => Dict( "display" => "block", "margin" => [20,20,20,20], "height" => 1, "color" => "darkgrey" ),
...
"p" => Dict( "display" => "block", "margin" => [0, 16, 0, 16], "font" =>  Dict( "size" => 13, "family" => "Sans", "color" => "black" )),
# <pre>	        Defines preformatted text
"pre" => Dict( "display"=>"block", "font" =>  Dict( "size" => 13, "family" => "Courier New", "color" => "black" )),
...
"small" => Dict( "font" =>  Dict( "size" => 10, "family" => "Sans", "color" => "black" )),
# <span>	    Defines a section in a document
"span" => Dict( "display"=>"inline", "font" =>  Dict( "size" => 13, "family" => "Sans", "color" => "black" )),
# <strong>	    Defines important text
"strong" => Dict( "font" =>  Dict( "weight"=>"bold", "size" => 13, "family" => "Sans", "color" => "black" )),
...
#= Other element types which may be errelevant in this project
...
"ins" => Dict( "font" =>  Dict( "size" => 13, "family" => "Sans", "color" => "black" )),
...
"link" => Dict( "font" =>  Dict( "weight "=> "normal", "size" => 13, "family" => "Sans", "color" => "black" )),
